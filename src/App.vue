<template>
  <div>
    <div>
      Source network: {{ sourceChainName }}
    </div>
...
const sendSwapTransaction = async () => {
  ...
  const sourceChain = chains.find(i => i.name === sourceChainName)
  const destinationChain = chains.find(i => i.name === destinationChainName)
  ...
  const swapParams: CheckoutOperationParams = {
    ...
    chainIdFrom: sourceChain,
    chainIdTo: destinationChain,
